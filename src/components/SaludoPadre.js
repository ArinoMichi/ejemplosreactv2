...
function SaludoPadre(){
    //NECESITAMOS UN METODO PARA PODER EJECUTAR LA ACCION CUANDO EL HIJO LO NECESITE
    const metodoPadre =(nombre) =>{
        console.log("Yo soy tu Padre, " + nombre);
    }
    return (<div>
        <h1 style={{color: "brown"}}>SALUDO PARENT</h1>
        {/* EL METODO LO LLAMAREMOS DESDE EL HIJO, POR LO QUE DEBEMOS ENVIAR
         MEDIANTE PROPS EL METODO AL HIJO EN SU DIBUJO */}
