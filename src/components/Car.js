...
function Car(props) {
  ...
  //VAMOS A TENER UNA FUNCIONALIDAD QUE NOS PERMITIRA ARRANCAR/DETENER
  //EL COCHE MEDIANTE LA VARIABLE ESTADO
  //TENDREMOS UN METODO QUE NOS DEVOLVERA UN DIBUJO HTML DEPENDIENDO DE DICHO ESTADO
  ...
  return (
    <div>
      ...
      <h1 style={{ color: "brown" }}>Velocidad actual {velocidad} Km/h</h1>
      <div>
        {comprobarEstado()}
      </div>
        <button onClick={() =>{
